...
const help = {
  ...
  buybacks: {
    ...
    sections: [
      ["What this workflow is for", ["Resolve regular Week 2 or preseason Track buybacks after payment is handled outside Loser League.", "This workflow records decisions and reactivations; it does not process money."]],
      ...
      ["Steps", ["Choose Pending requests or Eligible Users.", "Review the User and each Track’s eliminating Pick.", "Select only Tracks with confirmed external payment.", "Check the payment-confirmed box and review the confirmation before completing."]],
      ["What confirmation does", ["Selected Tracks are reactivated while their factual eliminating Wrong Picks remain in history and remain used.", "Unselected Tracks in a completed request are recorded unfulfilled.", "The User’s buyback decision closes and surviving active Tracks become available for Picks."]],
