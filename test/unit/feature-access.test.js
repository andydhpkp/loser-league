...
test("Pick Reminders availability fails closed when absent or invalid", () => {
  const off = { pickRemindersSystemAvailable: false, pickRemindersEmailDeliveryAvailable: false, pickRemindersPushDeliveryAvailable: false, pickRemindersAdminCampaignAvailable: false, pickRemindersCalendarAvailable: false };
  ...
  assert.deepEqual(buildFeatureConfiguration({ PICK_REMINDERS_SYSTEM_AVAILABLE: "true", PICK_REMINDERS_EMAIL_DELIVERY_AVAILABLE: "true", PICK_REMINDERS_PUSH_DELIVERY_AVAILABLE: "false", PICK_REMINDERS_ADMIN_CAMPAIGN_AVAILABLE: "true", PICK_REMINDERS_CALENDAR_AVAILABLE: "true" }), {
    pickRemindersSystemAvailable: true, pickRemindersEmailDeliveryAvailable: true, pickRemindersPushDeliveryAvailable: false, pickRemindersAdminCampaignAvailable: true, pickRemindersCalendarAvailable: true, invalidSettings: [],
  });
});
